  ...
  return (
    <div className="sticky" style={{ top: "144px", zIndex: index + 1 }}>
      <motion.div
        ...
        className={`lg:h-[520px] bg-blush-100 rounded-[30px] p-2.5 gap-2.5 flex flex-col lg:flex-row ${isLeft ? "" : "lg:flex-row-reverse"
          }`}
      >
        {/* Image */}
...
export function Services({ badge, headline, services, bookingUrl }: ServicesProps) {
  ...
  return (
    <section id="services">
      ...
      {/* Cards — each with its own sticky, later cards overlap earlier ones by DOM order */}
